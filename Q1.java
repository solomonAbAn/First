...
public class Q1 {
    ...
    public static void main(String[] args) { 
        ...
        while(true) { 
            ...
            patternNumber = validPatternInput(kb); 
        
            	inputValue = validInputValue(kb);//this is before the switch
    ...
    private static int validPatternInput(Scanner kb) { //Prompt valid user pattern input: an integer of 1-5
        ...
        if (patternNumber == 5) {System.out.println("Thank you for using my printer, Hope to see you again!");
      System.exit(0);
  }
    ...
    private static void displayPattern1(int inputValue) { //To Print Pattern 1
    ...
    private static void displayPattern2(int inputValue) { //To Print Pattern 2
    ...
    private static void displayPattern3(int inputValue) { //To print Pattern 3
        for (int i = 1; i <= inputValue; i++) {
            for (int j = 1; j <= i - 1; j++) { // Determines spaces before numbers
                System.out.print(" ");
            }
    ...
    private static void displayPattern4(int inputValue) { //To print pattern 4
